                          ...
                          int32_t event_id, void *event_data)
{
    ...
    else if (event_base == IP_EVENT && event_id == IP_EVENT_STA_GOT_IP)
    {
        ...
        xEventGroupClearBits(ConnectionEvents, WIFI_FAIL_BIT);
    }
}
...
void wifi_init_sta(void)
{
     ...
     * number of re-tries (WIFI_FAIL_BIT_BIT). The bits are set by event_handler() (see above) */
    EventBits_t bits = xEventGroupWaitBits(ConnectionEvents,
